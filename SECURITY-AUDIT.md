...
|---|----------|-------|----------|--------|
| 1 | Critical | Hardcoded admin password `admin2026` shipped in client bundle | `docs/script.js` | Fixed (removed) |
...
| 6 | Medium | No Content-Security-Policy; page allowed arbitrary inline script and remote resources | `docs/*.html`, `frontend/index.html` | Fixed (CSP meta tag, inline `onclick` handlers removed) |
